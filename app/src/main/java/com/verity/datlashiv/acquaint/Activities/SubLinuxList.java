    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                JSONArray array = object.getJSONArray("Linux_concepts");
                for (int j = 0; j < array.length(); j++) {
                    JSONObject object1 = array.getJSONObject(j);

                    mc.add(new MainCourse(object1.getString("linux_name"),
        ...
        rv.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), rv, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SubLinuxList.this, PVActivity.class);
